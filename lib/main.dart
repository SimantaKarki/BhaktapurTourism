          ...
          child: Column(
            children: <Widget>[
              Container(
                ...
                padding:EdgeInsets.only(top:35.0,left:0.0,bottom: 10.0,right:0.0),
                  child:Container(
                              ...
                              new Container(
                                ...
                                decoration: new BoxDecoration(
                                    ...
                                    image: new DecorationImage(
                                        fit: BoxFit.fill
                                        ,image: new NetworkImage("https://imgur.com/BoN9kdC.png"))
              ...
              Padding(
                padding:EdgeInsets.only(top:15.0,left:20.0,bottom:8.0,right:20.0),
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: <Widget>[
                    Text("Trending",
...
//                              ),
                  ...
                  CircleAvatar(
                                ...
                                backgroundImage: NetworkImage('https://unsplash.com/photos/5dYf6gPFVrA'),
                              ),
        ...
        persistentFooterButtons:
            ...
            Padding(
              ...
              child: IconButton(icon: Icon(Icons.face,
                ...
                Navigator.push(context, MaterialPageRoute(builder: (context) => settingRoute())
              );
              }
            ),
            )
...
//                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
  ...
  final carousel = Carousel(
    ...
    images: [
     ...
     AssetImage('assets/image_04.jpg'),
    ],
